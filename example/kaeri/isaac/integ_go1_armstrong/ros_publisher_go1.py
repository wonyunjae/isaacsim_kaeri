...
def ros_joint_state_publisher_go1():
    keys = og.Controller.Keys
...
def ros_joints_tf_publisher_go1(bodies):
    keys = og.Controller.Keys
...
def ros_sensors_tf_publisher_go1(): 
    keys = og.Controller.Keys 
    (graph, _, _, _) = og.Controller.edit( 
        { 
...
def ros_foot_contact_publisher_go1():
    keys = og.Controller.Keys
    (graph, _, _, _) = og.Controller.edit(
        {
...
def ros_lidar_publisher_go1(frame_id, topic_name, lidar_prim):
    keys = og.Controller.Keys
...
def ros_d455_publisher_go1(frame_id, namespace, topic_name, depth_prim, rgb_prim):
    keys = og.Controller.Keys

...
class Go1_runner(object):
    def __init__(self) -> None:
        ...
        self._go1 = self._world.scene.add(
            Unitree(
                prim_path="/World/Go1", name="Go1", position=np.array([0, 0, 1.0]), physics_dt=1.0/self.physics_freq, usd_path = PACKAGE_PATH + "/model/go1/go1.usd", model="Go1"
            )
        )
        ...
        prim_lidar = get_prim_at_path("/World/Sensors/lidar")

        # d455 front
        asset_path = PACKAGE_PATH + "/model/sensors/Realsense_D455_1.usd"
        add_reference_to_stage(usd_path=asset_path, prim_path="/World/Sensors")
        prim_d455_front = get_prim_at_path("/World/Sensors/Realsense_D455_1")

        # d455 rear
        asset_path = PACKAGE_PATH + "/model/sensors/Realsense_D455_2.usd"
        add_reference_to_stage(usd_path=asset_path, prim_path="/World/Sensors")
        prim_d455_rear = get_prim_at_path("/World/Sensors/Realsense_D455_2")

        # d455 left
        asset_path = PACKAGE_PATH + "/model/sensors/Realsense_D455_3.usd"
        add_reference_to_stage(usd_path=asset_path, prim_path="/World/Sensors")
        prim_d455_left = get_prim_at_path("/World/Sensors/Realsense_D455_3")

        # d455 right
        asset_path = PACKAGE_PATH + "/model/sensors/Realsense_D455_4.usd"
        add_reference_to_stage(usd_path=asset_path, prim_path="/World/Sensors")
        prim_d455_right = get_prim_at_path("/World/Sensors/Realsense_D455_4")

        # =-=-=-=-=-=-=-=-=-=-=-= [joint] =-=-=-=-=-=-=-=-=-=-=-=
        # [get go1 base pose]
        # fixed joint
        prim_go1_trunk = self._world.scene.stage.GetPrimAtPath("/World/Go1/trunk")
        ...
        fixed_joint_go1_to_lidar.CreateBody1Rel().SetTargets([prim_lidar.GetPrimPath()])
        ...
        try:
            ...
            if self.cfg_og["ros_d455_publisher"]["enable"]:
                self._d455_graph_front = ros_d455_publisher(frame_id = "d455_front" , 
                                                            ...
                                                            camera_prim="/World/Sensors/Realsense_D455_1/RSD455/Camera_Pseudo_Depth")
            ...
            if self.cfg_og["ros_d455_publisher"]["enable"]:
                self._d455_graph_rear = ros_d455_publisher(frame_id = "d455_rear" , 
                                                           namespace="d455_rear", 
                                                           topic_name = self.cfg_og["ros_d455_publisher"]["topic"],
                                                           camera_prim="/World/Sensors/Realsense_D455_2/RSD455/Camera_Pseudo_Depth")
            ...
            if self.cfg_og["ros_d455_publisher"]["enable"]:
                self._d455_graph_left = ros_d455_publisher(frame_id = "d455_left" , 
                                                           namespace = "d455_left", 
                                                           topic_name = self.cfg_og["ros_d455_publisher"]["topic"],
                                                           camera_prim = "/World/Sensors/Realsense_D455_3/RSD455/Camera_Pseudo_Depth")
            ...
            if self.cfg_og["ros_d455_publisher"]["enable"]:
                self._d455_graph_right = ros_d455_publisher(frame_id = "d455_right" ,
                                                            ...
                                                            topic_name = self.cfg_og["ros_d455_publisher"]["topic"],
                                                            camera_prim="/World/Sensors/Realsense_D455_4/RSD455/Camera_Pseudo_Depth")

...
class Articulation(RigidObject):
    ...
    def _update_common_data_overriding(self, dt: float):
        ...
        self._data.body_state_w[..., :7] = torch.from_numpy(self.body_physx_view.get_transforms()).view(-1, self.num_bodies, 7)
        self._data.body_state_w[..., 3:7] = math_utils.convert_quat(self._data.body_state_w[..., 3:7], to="wxyz")
        self._data.body_state_w[..., 7:] = torch.from_numpy(self.body_physx_view.get_velocities()).view(-1, self.num_bodies, 6)
        # -- body acceleration

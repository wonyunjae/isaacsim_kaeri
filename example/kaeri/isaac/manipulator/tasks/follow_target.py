...
from tasks.SingleManipulator import SingleManipulator
...
from isaacsim.core.utils.prims import create_prim import is_prim_path_valid
...
class FollowTarget(ABC, BaseTask):
    ...
    def set_robot(self) -> None:
        ...
        asset_path = PACKAGE_PATH + "/model/manipulator/openmanipulator_p/openmanipulator_p.usd"
        add_reference_to_stage(usd_path=asset_path, prim_path="/World" + "/" + self._name)

        manipulator = SingleManipulator(prim_path="/World" + "/" + self._name + "/openmanipulator_p",
                                        name=self._name,
                                        end_effector_prim_name="end_link")

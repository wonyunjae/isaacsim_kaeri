...
class OmniKaeriRos_bridgeExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[omni.kaeri.ros_bridge] OmniKaeriRos_bridgeExtension startup", flush=True)

    def on_shutdown(self):
        print("[omni.kaeri.ros_bridge] OmniKaeriRos_bridgeExtension shutdown", flush=True)
